...
export interface ApiAboutUsAboutUs extends Schema.SingleType {
  ...
  attributes: {
    ...
    body: Attribute.Component<'main.about-us-body'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBmPMethodBmPMethod extends Schema.SingleType {
  collectionName: 'bm_p_methods';
  info: {
    singularName: 'bm-p-method';
    pluralName: 'bm-p-methods';
    displayName: 'BM@P METHOD';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    advantage: Attribute.Component<'main.card-body'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    bmapSolves: Attribute.Component<'main.differentiator-body'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactFormContactForm extends Schema.CollectionType {
  ...
  attributes: {
    ...
    typeOfService: Attribute.Enumeration<
      [
        'Branding',
        'Creative Content',
        'Content Strategy',
    ...
    objective: Attribute.Enumeration<
    ...
    budget: Attribute.Enumeration<
      ['<RM5,000', 'RM5,000 - RM20,000', '>RM20,000']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiContactUsContactUs extends Schema.SingleType {
  ...
  attributes: {
    ...
    backImage: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    social: Attribute.Component<'social-media-links.social'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    contactInfo: Attribute.Component<'contact-info.contact-us'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    ourStory: Attribute.Component<'home-page.our-story'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ourMethod: Attribute.Component<'home-page.our-method'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ourExpertise: Attribute.Component<'home-page.our-expertise'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOurStoryOurStory extends Schema.SingleType {
  ...
  attributes: {
    body: Attribute.Component<'home-page.our-story'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPrivacyAndPolicyPrivacyAndPolicy extends Schema.SingleType {
  ...
  info: {
    ...
    displayName: 'Privacy and Policy';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    body: Attribute.Component<'main.page-content'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    heading: Attribute.Component<'service.service-heading'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    differentiator: Attribute.Component<'main.differentiator-body'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    caseStudyTitle2: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    coreFeatures: Attribute.Component<'main.differentiator-body'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServicesPageServicesPage extends Schema.SingleType {
  ...
  attributes: {
    body: Attribute.Component<'home-page.our-expertise'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiWebsiteConfigurationWebsiteConfiguration
  ...
  attributes: {
    ...
    socialMediaLinks: Attribute.Component<'social-media-links.social-media-links'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    nav: Attribute.Component<'main.header', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    footer: Attribute.Component<'main.footer'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    navButton: Attribute.Component<'shared.buttons'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::bm-p-method.bm-p-method': ApiBmPMethodBmPMethod;
